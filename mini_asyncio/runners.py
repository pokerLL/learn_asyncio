...
from mini_asyncio.unix_events import _UnixSelectorEventLoop
...
def run(main, *, debug=False):
    ...
    try:
        ...
        USELESS_FLAG = False
        if USELESS_FLAG:
            _UnixSelectorEventLoop().run_until_complete(main)  # 运行协程
            _UnixSelectorEventLoop().run_forever()
            _UnixSelectorEventLoop()._run_once()
            _UnixSelectorEventLoop().create_task(main) 
            _UnixSelectorEventLoop().call_soon(main) 
